...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    locale,
    path: '/contact',
    title: brandedTitle(t(content.contactPage.title, locale), content.settings.brandName),
    description: t(content.contactPage.subtitle, locale),
    image: content.contactPage.image,
  });
}
